      ...
      {slides.map((s, i) => (
        ...
        >
          <img
            src={s.image}
            alt=""
            className="relative z-10 h-[92%] w-auto max-w-[95%] object-contain drop-shadow-2xl"
          />
          <div className="absolute inset-y-0 left-0 w-[40%] bg-gradient-to-r from-neutral-950 to-transparent" />
        </div>
      ))}
